...
export default function AiSuperHelpersIframe() {
      ...
      <div className="relative w-[90%] h-[90%] bg-white rounded-lg shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between p-4 bg-slate-800 text-white">
          <div className="flex items-center">
            <h2 className="text-xl font-bold">AI Super Helpers</h2>
          </div>
        ...
        <iframe
          src="https://dashboard.superhelpers.ai/"
          className="w-full h-[calc(100%-64px)]"
          frameBorder="0"
          title="AI Super Helpers Dashboard"
        />
      </div>
    </div>
  )
